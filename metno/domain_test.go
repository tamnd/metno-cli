...
// HTTP behaviour is covered in metno_test.go.
...
func TestHostWiring(t *testing.T) {
	...
	if want := "metno://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("metno", "about")
	if err != nil || got.String() != "metno://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want metno://page/about", got.String(), err)
	}
}
