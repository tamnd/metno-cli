...
Most of these come down to network reality or how metno serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

metno rate-limits like any public site. metno already paces
...
Where a surface is gated, metno reads a cookie or token you supply
...
`metno`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what metno actually did
